...
def build_parser() -> argparse.ArgumentParser:
    ...
    ingest_discover.set_defaults(func=cmd_ingest_discover)
    ...
    ingest_run.set_defaults(func=cmd_ingest_run)
    ...
    validate_quotes.set_defaults(func=cmd_validate_quotes)
    ...
    validate_trades.set_defaults(func=cmd_validate_trades)
    ...
    dim_symbol_upsert.set_defaults(func=cmd_dim_symbol_upsert)
    ...
    dim_symbol_sync.set_defaults(func=cmd_dim_symbol_sync)
    ...
    dim_asset_stats_sync.set_defaults(func=cmd_dim_asset_stats_sync)
    ...
    dim_asset_stats_backfill.set_defaults(func=cmd_dim_asset_stats_backfill)
