...
CN_ORDER_EVENTS = TableSpec(
    ...
    column_specs=(
        *_common_cn_event_columns(),
        ...
        ColumnSpec("source_side_raw", pl.Utf8, nullable=True),
        ColumnSpec("source_ord_type_raw", pl.Utf8, nullable=True),
        ColumnSpec("source_order_action_raw", pl.Utf8, nullable=True),
        ColumnSpec("source_exchange_seq", pl.Int64, nullable=True),
        ColumnSpec("source_exchange_order_index", pl.Int64, nullable=True),
    ),
...
CN_TICK_EVENTS = TableSpec(
    ...
    column_specs=(
        *_common_cn_event_columns(),
        ...
        ColumnSpec("price", pl.Int64, scale=PRICE_SCALE),
        ColumnSpec("qty", pl.Int64, scale=QTY_SCALE),
        ColumnSpec("source_exec_type_raw", pl.Utf8),
        ColumnSpec("source_trade_side_raw", pl.Utf8, nullable=True),
        ColumnSpec("source_exchange_seq", pl.Int64, nullable=True),
        ColumnSpec("source_exchange_trade_index", pl.Int64, nullable=True),
    ),
    partition_by=("exchange", "trading_date"),
    business_keys=(),
    tie_break_keys=(
...
CN_L2_SNAPSHOTS = TableSpec(
    ...
    column_specs=(
        *_common_cn_event_columns(),
        ...
        ColumnSpec("source_image_status_raw", pl.Utf8, nullable=True),
        ColumnSpec("source_trading_phase_raw", pl.Utf8, nullable=True),
