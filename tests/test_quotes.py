...
def test_quotes_service_ingest_file_quarantine():
    ...
    bronze_rel_path = "exchange=binance/type=quotes/date=2024-05-01/symbol=BTCUSDT/test.csv"
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".csv", delete=False) as f:
        f.write(
            "exchange,symbol,timestamp,local_timestamp,bid_price,bid_amount,ask_price,ask_amount\n"
        )
