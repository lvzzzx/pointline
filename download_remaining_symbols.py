#!/usr/bin/env python3
"""Download derivative_ticker data for the remaining 3 symbols.

This script downloads for:
- BTCUSDT
- ETHUSDT
- SOLUSDT

From 2024-09-01 to 2025-12-31.
"""
...
def main():
    # Configuration - only the 3 remaining symbols
    exchange = "binance-futures"
    data_types = ["derivative_ticker"]
    symbols = ["BTCUSDT", "ETHUSDT", "SOLUSDT"]  # Remaining symbols
    ...
    print("=" * 60)
    print("Downloading Remaining Symbols")
    print("=" * 60)
