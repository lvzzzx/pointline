"""Ingest BitMEX derivative_ticker bronze file into the data lake.

Usage:
    python scripts/ingest_bitmex_derivative_ticker.py
"""
...
BRONZE_FILE = Path(
    ...
    "/exchange=bitmex/type=derivative_ticker/date=2020-09-01"
    "/symbol=PERPETUALS/bitmex_derivative_ticker_2020-09-01_PERPETUALS.csv.gz"
)
...
def bootstrap_dim_symbol_from_csv(path: Path) -> pl.DataFrame:
    ...
    effective_ts_us = 1_500_000_000_000_000  # ~2017-07, before 2020-09-01
